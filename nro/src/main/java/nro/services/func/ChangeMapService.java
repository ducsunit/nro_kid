    ...
    private void sendEffectMeToMap(Player player) {
        ...
        try {
            ...
            if (player.mobMe != null) {
                ...
                msg.writer().writeInt(clampToInt(player.mobMe.point.getHP()));// hp mob
                Service.getInstance().sendMessAnotherNotMeInMap(player, msg);
                msg.cleanup();
            }
            if (player.pet != null && player.pet.mobMe != null) {
                ...
                msg.writer().writeInt(clampToInt(player.pet.mobMe.point.getHP()));// hp mob
                Service.getInstance().sendMessAnotherNotMeInMap(player, msg);
                msg.cleanup();
            }
        } catch (Exception e) {
                ...
                for (Player pl : players) {
                    if (!player.equals(pl)) {
                        ...
                        if (pl.mobMe != null) {
                            ...
                            msg.writer().writeInt(clampToInt(pl.mobMe.point.getHP()));// hp mob
                            player.sendMessage(msg);
                            msg.cleanup();
                        }
                    }
