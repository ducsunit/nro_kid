...
//                }
    ...
    private void infoPlayer(Player plReceive, Player plInfo) {
        ...
        try {
            ...
            msg.writer().writeInt((int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, plInfo.nPoint.hp)));
            msg.writer().writeInt((int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, plInfo.nPoint.hpMax)));
    ...
    public void mapInfo(Player pl) {
        ...
        try {
            ...
            for (Mob mob : mobs) {
                ...
                msg.writer().writeInt((int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, mob.point.getHP())));
                msg.writer().writeByte(mob.level);
                msg.writer().writeInt((int) Math.max(Integer.MIN_VALUE, Math.min(Integer.MAX_VALUE, mob.point.getHpFull())));
