                                        ...
                                        case 1:
                                            if (Manager.KHUYEN_MAI_NAP != 1) {
                                                this.createOtherMenu(player, ConstNpc.QUY_DOI_XU,
                                                        "|7|QUY ĐỔI ĐÁ NGŨ SẮC"
                                                                + "\n|6|Giới hạn đổi không quá 1.000.000 Coin"
                                                                + "\n|1|Coin hiện còn : " + " " + Util.format(player.getSession().vnd)
                                                                + "\n\n|5|Nhập 10.000 Coin được 50 Đá Ngũ Sắc"
                                                                + "\n|3| Server đang x" + Manager.KHUYEN_MAI_NAP + " Quy đổi "
                                                                + "(10.000 Coin = " + Util.format(Manager.KHUYEN_MAI_NAP * 50) + " Đá Ngũ Sắc)",
                                                        "Đồng ý", "Từ chối");
                                            } else {
                                                this.createOtherMenu(player, ConstNpc.QUY_DOI_XU,
                                                        "|7|QUY ĐỔI ĐÁ NGŨ SẮC"
                    ...
                    npc = new Npc(mapId, status, cx, cy, tempId, avartar) {
                        ...
                        public void openBaseMenu(Player player) {
                            if (canOpenNpc(player)) {
                                ...
                                if (!TaskService.gI().checkDoneTaskTalkNpc(player, this)) {
                                    this.createOtherMenu(player, ConstNpc.BASE_MENU,
                                            "Hãy cùng khám phá Thế Giới Kid này nào\n"
...
//                                                    + player.getSession().vnd + " VND"
                                                    + "\nGiftcode\ntanthu - chaomung - kidnew1 - kidnew2 - kidnew3"
                                                    + "\n\n|2| ***" + mtv + "***",
...
//                                            }
                                        ...
                                        case 6:
                                            ...
                                            this.createOtherMenu(player, 1432,
                                                    "|7|QÙA MỐC NẠP"
                                                            ...
                                                            + "\n\n|5|" + "- Mốc 20K: 5 bộ ngọc rồng 1s, 1 trứng đệ tử Mabu"
                                                            + "\n- Mốc 50k : 5 Bộ Ngọc rồng 1s, 10 item Cuồng Bạo"
                                                            + "\n- Mốc 100k : 50 Hộp sách kỹ năng, 30 item Cuồng Bạo"
                                                            + "\n- Mốc 200k : 100 Hộp sách kỹ năng, 40 item Cuồng Bạo"
                                                            + "\n- Mốc 300k : 150 Hộp sách kỹ năng, 50 item Cuồng Bạo"
                                                            + "\n- Mốc 400k : 200 Hộp sách kỹ năng, 60 item Cuồng Bạo,1 trứng đệ Berus"
                                                            + "\n- Mốc 500k : 250 Hộp sách kỹ năng, 99 Máy dò Boss, 100 Hộp pháp sư, 10 rương Sao pha lê VIP, 1 trứng đệ Zeno"
                                                            + "\n Mốc 1tr : 30 Kẹo một mắt, 20 Đá Ngũ Sắc, 100 Hộp pháp sư, 20 Viên Ngọc rồng Siêu cấp, Hộp đồ kích hoạt thần linh"
                                                            + "\n Mốc 2tr : 100 Capsule Bạc, 100 Capsule Vàng, 500 Đá Hoàng Kim, 50 Viên Ngọc rồng Siêu cấp, Hộp đồ kích hoạt huỷ diệt"
                                                            + "\n Mốc 2tr5 : 200 Capsule Bạc, 200 Capsule Vàng, 500 Đá Hoàng Kim, 15.000 Thỏi vàng, Hộp đồ kích hoạt thiên sứ"
                                    ...
                                    switch (select) {
                                        case 0:
                                            ...
                                            if (player.tongnap >= 20_000 && player.mot == 0) {
                                                player.mot++;
                                                ...
                                                Item eggMabu = ItemService.gI().createNewItem((short) 1538);
                                                nro1.quantity = 5;
                                                nro2.quantity = 5;
                                                nro3.quantity = 5;
                                                nro4.quantity = 5;
                                                ...
                                                InventoryService.gI().addItemBag(player, eggMabu, 99);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 5 Bộ Ngọc rồng 1s, 1 trứng đệ tử Mabu");
                                            }
                                            break;
                                        case 1:
                                            if (player.tongnap < 50_000) {
                                                this.npcChat(player, "|7|Bạn chưa đủ điều kiện nhận!!!!");
                                                return;
                                            }
                                            if (player.hai != 0) {
                                            ...
                                            if (player.tongnap >= 50_000 && player.hai == 0 && player.mot != 0) {
                                                player.hai++;
                                                Item nro1 = ItemService.gI().createNewItem((short) 14);
                                                Item nro2 = ItemService.gI().createNewItem((short) 15);
                                                Item nro3 = ItemService.gI().createNewItem((short) 16);
                                                ...
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "5 bộ ngọc rồng 1s, 10 item cuồng bạo");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 2:
                                            if (player.tongnap < 100_000) {
                                                this.npcChat(player, "|7|Bạn chưa đủ điều kiện nhận!!!!");
                                                return;
                                            }
                                            if (player.ba != 0) {
                                        ...
                                        case 3:
                                            ...
                                            if (player.tongnap >= 200_000 && player.bon == 0 && player.ba != 0) {
                                                player.bon++;
                                                Item ruongSach = ItemService.gI().createNewItem((short) 1525);
                                                Item cuongBao = ItemService.gI().createNewItem((short) 1386);
                                                ruongSach.quantity = 100;
                                                cuongBao.quantity = 40;
                                                InventoryService.gI().addItemBag(player, ruongSach, 99);
                                                InventoryService.gI().addItemBag(player, cuongBao, 99);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 100 Hộp sách kỹ năng, 40 item Cuồng Bạo");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 4:
                                            if (player.tongnap < 300_000) {
                                                this.npcChat(player, "|7|Bạn chưa đủ điều kiện nhận!!!!");
                                                return;
                                            }
                                            if (player.nam != 0) {
                                            ...
                                            if (player.tongnap >= 300_000 && player.nam == 0 && player.bon != 0) {
                                                player.nam++;
                                                Item ruongSach = ItemService.gI().createNewItem((short) 1525);
                                                Item cuongBao = ItemService.gI().createNewItem((short) 1386);
                                                ruongSach.quantity = 150;
                                                cuongBao.quantity = 50;
                                                InventoryService.gI().addItemBag(player, ruongSach, 99);
                                                InventoryService.gI().addItemBag(player, cuongBao, 99);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 150 Hộp sách kỹ năng, 50 item Cuồng Bạo");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 5:
                                            ...
                                            if (player.tongnap >= 400_000 && player.sau == 0 && player.nam != 0) {
                                                player.sau++;
                                                Item ruongSach = ItemService.gI().createNewItem((short) 1525);
                                                Item cuongBao = ItemService.gI().createNewItem((short) 1386);
                                                Item eggBerus = ItemService.gI().createNewItem((short) 1539);
                                                ruongSach.quantity = 200;
                                                cuongBao.quantity = 60;
                                                eggBerus.quantity = 1;
                                                InventoryService.gI().addItemBag(player, ruongSach, 99);
                                                InventoryService.gI().addItemBag(player, cuongBao, 99);
                                                InventoryService.gI().addItemBag(player, eggBerus, 1);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 200 hộp sách kĩ năng, 60 item cuồng bạo, 1 trứng đệ tử Berus");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 6:
                                            ...
                                            if (player.tongnap >= 500_000 && player.bay == 0 && player.sau != 0) {
                                                player.bay++;
                                                Item ruongSach = ItemService.gI().createNewItem((short) 1525);
                                                Item mayDoBoss = ItemService.gI().createNewItem((short) 1296);
                                                Item hopPhapSu = ItemService.gI().createNewItem((short) 1237);
                                                Item saoPhaLeVip = ItemService.gI().createNewItem((short) 1479);
                                                Item eggZeno = ItemService.gI().createNewItem((short) 1540);
                                                ruongSach.quantity = 250;
                                                mayDoBoss.quantity = 90;
                                                hopPhapSu.quantity = 100;
                                                saoPhaLeVip.quantity = 10;
                                                eggZeno.quantity = 1;
                                                InventoryService.gI().addItemBag(player, ruongSach, 99);
                                                InventoryService.gI().addItemBag(player, mayDoBoss, 99);
                                                InventoryService.gI().addItemBag(player, hopPhapSu, 99);
                                                InventoryService.gI().addItemBag(player, saoPhaLeVip, 99);
                                                InventoryService.gI().addItemBag(player, eggZeno, 1);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 250 hộp sách kĩ năng, 99 máy dò Boss, 100 hộp pháp sư, 10 rương sao pha lê vip, 1 trứng đệ Zeno");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 7:
                                            if (player.tongnap < 1_000_000) {
                                                this.npcChat(player, "|7|Bạn chưa đủ điều kiện nhận!!!!");
                                                return;
                                            }
                                            if (player.tam != 0) {
                                            ...
                                            if (player.tongnap >= 1_000_000 && player.tam == 0 && player.bay != 0) {
                                                player.tam++;
                                                Item keoMotMat = ItemService.gI().createNewItem((short) 899);
                                                Item daNguSac = ItemService.gI().createNewItem((short) 674);
                                                Item hopPhapSu = ItemService.gI().createNewItem((short) 1237);
                                                Item nroSieuCap = ItemService.gI().createNewItem((short) 1015);
                                                Item kichHoatThanLinh = ItemService.gI().createNewItem((short) 1558);
                                                keoMotMat.quantity = 30;
                                                daNguSac.quantity = 20;
                                                hopPhapSu.quantity = 100;
                                                nroSieuCap.quantity = 20;
                                                kichHoatThanLinh.quantity = 1;
                                                InventoryService.gI().addItemBag(player, keoMotMat, 99);
                                                InventoryService.gI().addItemBag(player, daNguSac, 99);
                                                InventoryService.gI().addItemBag(player, hopPhapSu, 99);
                                                InventoryService.gI().addItemBag(player, nroSieuCap, 99);
                                                InventoryService.gI().addItemBag(player, kichHoatThanLinh, 1);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 30 kẹo 1 mắt, 20 đá ngũ sắc, 100 hộp sách kỹ năng, 20 viên ngọc rồng siêu cấp, hộp đồ kích hoạt thần linh");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 8:
                                            if (player.tongnap < 2_000_000) {
                                                this.npcChat(player, "|7|Bạn chưa đủ điều kiện nhận!!!!");
                                                return;
                                            }
                                            if (player.chin != 0) {
                                            ...
                                            if (player.tongnap >= 2_000_000 && player.chin == 0 && player.tam != 0) {
                                                player.chin++;
                                                ...
                                                Item nroSieuCap = ItemService.gI().createNewItem((short) 1015);
                                                Item kichHoatHuyDiet = ItemService.gI().createNewItem((short) 1559);
                                                capsulBac.quantity = 100;
                                                capsulVang.quantity = 100;
                                                daHoangKim.quantity = 500;
                                                nroSieuCap.quantity = 50;
                                                kichHoatHuyDiet.quantity = 1;
                                                InventoryService.gI().addItemBag(player, capsulBac, 99);
                                                InventoryService.gI().addItemBag(player, capsulVang, 99);
                                                InventoryService.gI().addItemBag(player, daHoangKim, 99);
                                                InventoryService.gI().addItemBag(player, nroSieuCap, 99);
                                                InventoryService.gI().addItemBag(player, kichHoatHuyDiet, 1);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 200 Capsul Bạc, 200 Capsul Vàng, 500 đá hoàng kim, 50 viên ngọc rồng siêu cấp, hộp đồ kích hoạt huỷ diệt");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                                        case 9:
                                            if (player.tongnap < 2_500_000) {
                                                this.npcChat(player, "|7|Bạn chưa đủ điều kiện nhận!!!!");
                                                return;
                                            }
                                            if (player.muoi != 0) {
                                            ...
                                            if (player.tongnap >= 2_500_000 && player.muoi == 0 && player.chin != 0) {
                                                player.muoi++;
                                                Item capsulBac = ItemService.gI().createNewItem((short) 573);
                                                Item capsulVang = ItemService.gI().createNewItem((short) 574);
                                                Item daHoangKim = ItemService.gI().createNewItem((short) 1318);
                                                Item thoiVang = ItemService.gI().createNewItem((short) 457);
                                                Item kichHoatThienSu = ItemService.gI().createNewItem((short) 1105);
                                                capsulBac.quantity = 200;
                                                capsulVang.quantity = 200;
                                                daHoangKim.quantity = 500;
                                                thoiVang.quantity = 15_000;
                                                kichHoatThienSu.quantity = 1;
                                                InventoryService.gI().addItemBag(player, capsulBac, 99);
                                                InventoryService.gI().addItemBag(player, capsulVang, 99);
                                                InventoryService.gI().addItemBag(player, daHoangKim, 99);
                                                InventoryService.gI().addItemBag(player, thoiVang, 99);
                                                InventoryService.gI().addItemBag(player, kichHoatThienSu, 1);
                                                InventoryService.gI().sendItemBags(player);
                                                this.npcChat(player, "Bạn nhận được 200 capsul Bạc, 200 capsul Vàng, 500 đá hoàng kim, 15.000 thỏi vàng, hộp đồ kích hoạt thiên sứ");
                                            } else {
                                                Service.getInstance().sendThongBao(player, "Vui lòng nhận các mốc nạp trước đó để nhận được mốc nạp này");
                                            }
                                            break;
                        ...
                        if (((TaiXiu.gI().lastTimeEnd - System.currentTimeMillis()) / 1000) > 0 && player.goldTai == 0 && player.goldXiu == 0 && TaiXiu.gI().baotri == false) {
                            switch (select) {
                                case 0:
                                    ...
                                    break;
                                case 1:
                                    System.out.println("Session active status: " + player.getSession().actived);
                                    if (player.getSession().actived) {
