...
public class Inventory {
    ...
    public static final long LIMIT_GOLD = Integer.MAX_VALUE; // gioi han chua vang theo int
...
//        itemsReward = new ArrayList<>();
    ...
    public long getGoldLimit() {
        long limit = goldLimit + LIMIT_GOLD;
        return Math.max(0, Math.min(Integer.MAX_VALUE, limit));
    }

    public long getGoldDisplay() {
        return Math.max(0, Math.min(Integer.MAX_VALUE, gold));
    }
