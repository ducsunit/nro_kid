namespace Mod
{
	public class AutoPoint : IActionListener, IChatable
	{
		...
		public static void ShowMenu()
		{
			...
			myVector.addElement(new Command("Tự Động", getInstance(), 1, null));
			myVector.addElement(new Command("Cộng Chỉ Số", getInstance(), 2, null));
		...
		{
			MyVector myVector = new MyVector();
			myVector.addElement(new Command("Auto\n" + (isAutoPoint ? "[ON]" : "[OFF]"), getInstance(), 3, null));
