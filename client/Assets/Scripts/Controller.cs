...
public class Controller : IMessageHandler
{
	...
	public static bool isLoadingData = true;
	...
	public void onMessage(Message msg)
	{
		...
		try
		{
			...
			case -42:
				...
				Char.myCharz().cCriticalFull = msg.reader().readUnsignedByte();
				Char.myCharz().cTiemNang = msg.reader().readLong();
				Char.myCharz().expForOneAdd = msg.reader().readShort();
				Char.myCharz().cDefGoc = msg.reader().readShort();
				Char.myCharz().cCriticalGoc = msg.reader().readUnsignedByte();
				InfoDlg.hide();
				break;
			case 1:
			{
			...
			case -107:
			{
				...
				Char.myPetz().cCriticalFull = msg.reader().readUnsignedByte();
